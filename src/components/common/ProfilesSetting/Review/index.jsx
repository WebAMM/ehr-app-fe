...
import { useGetClinicReviewsQuery, useGetDoctorReviewsQuery } from "@/services";
...
const Reviews = () => {
  ...
  const {
    data: doctorReview,
    isLoading: doctorReviewIsLoading,
    isError: doctorReviewIsError,
  ...
  const {
    data: clinicReview,
    isLoading: clinicReviewIsLoading,
    isError: clinicReviewIsError,
  } = useGetClinicReviewsQuery({ id: doctorId }, { skip: !isClinic });
  const {
    reviews: reviewsData,
    isLoading,
    isError,
